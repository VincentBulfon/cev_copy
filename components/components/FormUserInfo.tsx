...
import { checkParentUpdateInfosValidity } from 'helpers/validation';
...
import { UPDATE_USER_DATA_MUTATION } from 'operations/mutations/user';
import { isLoggedVar } from 'client/reactVars';
import {
  Update_User_Data_Mutation,
  Update_User_Data_MutationVariables,
} from 'operations/__generated__/Update_User_Data_Mutation';
...
const FormUserInfo = ({
  ...
  function checkValidity() {
    const errors = checkParentUpdateInfosValidity(formContent.parentContent);
  ...
  const [update_user_data] = useMutation<
    Update_User_Data_Mutation,
    Update_User_Data_MutationVariables
  >(UPDATE_USER_DATA_MUTATION, {
    variables: {
      updateUserData: {
        newUserData: {
          ...
          secondary_email: formContent.parentContent.secondaryEmail,
          password: formContent.parentContent.password,
        },
        whereUserInput: { id: isLoggedVar().isLogged },
      },
    },
  });
  ...
  return (
    <section
      ...
      <FormField
        value={formContent.parentContent.name || ''}
        name="name"
      ...
      <FormField
        value={formContent.parentContent.firstName || ''}
        name="firstName"
        onChange={handleChange}
        uniqueKey="none"
        id="firstname"
      ...
      <FormField
        value={formContent.parentContent.phone || ''}
        name="phone"
        onChange={handleChange}
        uniqueKey="none"
        id="phone"
      ...
      <FormField
        value={formContent.parentContent.email || ''}
        name="email"
        onChange={handleChange}
        uniqueKey="none"
        id="email"
      ...
      <FormField
        value={formContent.parentContent.secondaryEmail || ''}
        name="secondaryEmail"
        onChange={handleChange}
        uniqueKey="none"
        id="secondaryEmail"
      ...
      <FormField
        value={formContent.parentContent.password || ''}
        name="password"
        onChange={handleChange}
        uniqueKey="none"
        id="password"
      ...
      <FormField
        value={formContent.parentContent.repeatPassword || ''}
        name="repeatPassword"
        onChange={handleChange}
        uniqueKey="none"
        id="repeatPassword"
      ...
      <ConfirmButton
        validateAction={checkValidity}
        cancelAction={canceAction}
        validate="Modifier"
        cancel="Annuler"
      />
    </section>
